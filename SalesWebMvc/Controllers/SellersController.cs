...
namespace SalesWebMvc.Controllers
{
    public class SellersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SellerId,Name,Email,BirthDate,BaseSalary,DepartmentId")] Seller seller)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Department, "DepartmentId", "DepartmentId", seller.DepartmentId);
            return View(seller);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SellerId,Name,Email,BirthDate,BaseSalary,DepartmentId")] Seller seller)
        {
